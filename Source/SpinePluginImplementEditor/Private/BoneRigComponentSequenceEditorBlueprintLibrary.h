...
#include "BoneRigComponentSequenceEditorBlueprintLibrary.generated.h"
...
struct FBoneRigComponentSequencerChannelProxy
{
	GENERATED_BODY()

	FBoneRigComponentSequencerChannelProxy()
		: Section(nullptr)
	{}

	FBoneRigComponentSequencerChannelProxy(const FName& InChannelName, UMovieSceneSection* InSection)
...
UCLASS()
class SPINEPLUGINIMPLEMENTEDITOR_API UBoneRigComponentSequenceEditorBlueprintLibrary : public UBlueprintFunctionLibrary
{
public:
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Level Sequence Editor")
	static TArray<FBoneRigComponentSequencerChannelProxy> GetSelectedChannels();
	...
	/** Select channels */
	UFUNCTION(BlueprintCallable, Category = "Level Sequence Editor")
	static void SelectChannels(const TArray<FBoneRigComponentSequencerChannelProxy>& Channels);
