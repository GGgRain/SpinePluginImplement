...
#define LOCTEXT_NAMESPACE "BoneRigComponentSequenceEditorActorBinding"

FBoneRigComponentSequenceEditorActorBinding::FBoneRigComponentSequenceEditorActorBinding(TSharedRef<ISequencer> InSequencer)
	: Sequencer(InSequencer)
{
}

void FBoneRigComponentSequenceEditorActorBinding::BuildSequencerAddMenu(FMenuBuilder& MenuBuilder)
{
	MenuBuilder.AddSubMenu(
		...
		FNewMenuDelegate::CreateRaw(this, &FBoneRigComponentSequenceEditorActorBinding::AddPossessActorMenuExtensions),
		false /*bInOpenSubMenuOnClick*/,
		FSlateIcon("LevelSequenceEditorStyle", "LevelSequenceEditor.PossessNewActor")
		);
}

bool FBoneRigComponentSequenceEditorActorBinding::SupportsSequence(UMovieSceneSequence* InSequence) const
{
	return InSequence->GetClass() == UBoneRigComponentSequence::StaticClass();
}

void FBoneRigComponentSequenceEditorActorBinding::AddPossessActorMenuExtensions(FMenuBuilder& MenuBuilder)
{
...
void FBoneRigComponentSequenceEditorActorBinding::AddActorsToSequencer(AActor*const* InActors, int32 NumActors)
{
