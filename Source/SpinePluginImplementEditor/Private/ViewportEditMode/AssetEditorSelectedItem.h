...
//////////////////////////////////////////////////////////////////////////
// HDestructibleSpriteSelectableObjectHitProxy

struct HBoneBodyShapeHitProxy : public HHitProxy
{
	DECLARE_HIT_PROXY(SPINEPLUGINIMPLEMENT_API);

	TSharedPtr<FSelectedItem> Data;

	HBoneBodyShapeHitProxy(TSharedPtr<FSelectedItem> InData)
