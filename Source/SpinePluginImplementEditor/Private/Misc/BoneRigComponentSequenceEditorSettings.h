...
#include "BoneRigComponentSequenceEditorSettings.generated.h"

USTRUCT()
struct FBoneRigComponentSequencePropertyTrackSettings
{
	GENERATED_BODY()
...
USTRUCT()
struct FBoneRigComponentSequenceTrackSettings
{
	GENERATED_BODY()
	...
	TArray<FBoneRigComponentSequencePropertyTrackSettings> DefaultPropertyTracks;

	/** List of property names for which movie scene tracks will not be created automatically. */
	UPROPERTY(config, EditAnywhere, Category=TrackSettings)
	TArray<FBoneRigComponentSequencePropertyTrackSettings> ExcludeDefaultPropertyTracks;
};
...
class UBoneRigComponentSequenceEditorSettings
	: public UObject
{
	GENERATED_BODY()
...
public:
	...
	UBoneRigComponentSequenceEditorSettings(const FObjectInitializer& ObjectInitializer);
	...
	TArray<FBoneRigComponentSequenceTrackSettings> TrackSettings;
 ...
 */
UCLASS(config=EditorPerProjectUserSettings)
class UBoneRigComponentSequenceMasterSequenceSettings
	: public UObject
{
