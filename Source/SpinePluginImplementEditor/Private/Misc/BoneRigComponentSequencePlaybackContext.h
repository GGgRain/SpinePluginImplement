 ...
 */
class FBoneRigComponentSequencePlaybackContext : public TSharedFromThis<FBoneRigComponentSequencePlaybackContext>
{
public:

	FBoneRigComponentSequencePlaybackContext();
	~FBoneRigComponentSequencePlaybackContext();
