...
/* BoneRigComponentSequenceEditorHelpers
 *****************************************************************************/

#define LOCTEXT_NAMESPACE "BoneRigComponentSequenceEditorHelpers"
...
class SMasterSequenceSettings : public SCompoundWidget, public FGCObject
{
	SLATE_BEGIN_ARGS(SMasterSequenceSettings) {}
		SLATE_ARGUMENT(UBoneRigComponentSequenceMasterSequenceSettings*, MasterSequenceSettings)
		SLATE_ARGUMENT(UMovieSceneToolsProjectSettings*, ToolsProjectSettings)
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs)
	{
		const UBoneRigComponentSequenceMasterSequenceSettings* LevelSequenceSettings = GetDefault<UBoneRigComponentSequenceMasterSequenceSettings>();
	...
	void SetMasterSequenceSettings(UBoneRigComponentSequenceMasterSequenceSettings* InMasterSequenceSettings)
	{
...
private:
	...
	FReply OnCreateMasterSequence()
	{
		...
		UObject* MasterSequenceAsset = BoneRigComponentSequenceEditorHelpers::CreateLevelSequenceAsset(MasterSequenceAssetName, MasterSequencePackagePath);
	...
	UBoneRigComponentSequenceMasterSequenceSettings* MasterSequenceSettings;
	UMovieSceneToolsProjectSettings* ToolsProjectSettings;
};
	

void BoneRigComponentSequenceEditorHelpers::OpenMasterSequenceDialog(const TSharedRef<FTabManager>& TabManager)
{
	...
	UBoneRigComponentSequenceMasterSequenceSettings* MasterSequenceSettings = GetMutableDefault<UBoneRigComponentSequenceMasterSequenceSettings>();
...
UObject* BoneRigComponentSequenceEditorHelpers::CreateLevelSequenceAsset(const FString& AssetName, const FString& PackagePath, UObject* AssetToDuplicate)
{
