...
#include "BoneRigComponentSequence.generated.h"
...
class SPINEPLUGINIMPLEMENT_API UBoneRigComponentSequence : public ULevelSequence
{
...
public:
	...
	UPROPERTY(AssetRegistrySearchable)
	TSoftObjectPtr<UBoneRigComponent> LastExportedUsingSkeletalMesh;
